...
export default function Flashcard({
	...
	return (
		...
		>
			...
			{imageUrl && limitImageSize && (
				<span className="relative mt-3 block h-44 w-full max-w-lg shrink-0 overflow-hidden rounded-md border border-muted-foreground/20 sm:h-56">
					<Image
						src={imageUrl}
