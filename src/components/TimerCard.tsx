...
export default function TimerCard() {
	...
	return (
		<section
			className={`flex flex-col  w-full max-w-2xl overflow-hidden rounded-xl border border-border bg-muted shadow-sm transition-all duration-300 ease-in-out ${expand ? "h-full" : "h-13"}`}
		>
			...
			<div className=" flex flex-col items-center justify-between flex-1 py-3">
				...
				<div className="relative  flex size-56 items-center justify-center">
					<svg className="-rotate-90" viewBox="0 0 220 220" aria-hidden="true">
						<circle
							cx="110"
							cy="110"
							r={CIRCLE_RADIUS}
